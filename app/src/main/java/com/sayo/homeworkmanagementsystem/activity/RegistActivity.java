...
private Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.equals("")||password.equals("")||address.equals("")||phone.equals("")){
                    ...
                    String url= NetworkAPI.SERVER_ADDRESS +"/user/register";
                                ...
                                if(msg.equals("注册成功")){
                                   ...
                                   final String username_login = detail.getString("username");
                                    goLogin.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            Intent intent=new Intent(RegistActivity.this, com.sayo.homeworkmanagementsystem.activity.LoginActivity.class);
        ...
        goLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegistActivity.this, com.sayo.homeworkmanagementsystem.activity.LoginActivity.class));
            }
        });
    }
}